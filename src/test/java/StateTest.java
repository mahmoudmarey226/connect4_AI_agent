...
//                {'R','R','R','Y','R','R','Y',}
//        };
//        State fullState = new State(fullGrid);
//
//        ArrayList<char[][]> exRneighbours = new ArrayList<>();
//        exRneighbours.add(nr1);
//        exRneighbours.add(nr2);
//        exRneighbours.add(nr3);
//        exRneighbours.add(nr4);
//        exRneighbours.add(nr5);
//        exRneighbours.add(nr7);
//        ArrayList<char[][]> exYneighbours = new ArrayList<>();
//        exYneighbours.add(ny1);
//        exYneighbours.add(ny2);
//        exYneighbours.add(ny3);
//        exYneighbours.add(ny4);
//        exYneighbours.add(ny5);
//        exYneighbours.add(ny7);
//
//        ArrayList<char[][]> rNeighbours = arrayListToGrid(state.getAllNeighbours(true));
//        ArrayList<char[][]> yNeighbours = arrayListToGrid(state.getAllNeighbours(false));
//
...
//    }
//
//    private ArrayList<char[][]> arrayListToGrid(ArrayList<State> states) {
//        ArrayList<char[][]> result = new ArrayList<>();
//        for (int i = 0; i < states.size(); i++) {
//            result.add(states.get(i).toGrid());
//        }
//        return result;
//    }
//
